...
public class GUI extends JFrame implements ActionListener, KeyListener, MouseListener{    
    ...
    JComboBox receiverCombo, senderCombo, receiverComboTool, senderComboTool, languageComboTool;
    ...
    public GUI(){
        ...
        languageComboTool = new JComboBox(pList3);
        languageComboTool.addActionListener(this);
        ...
        conversationBox = new JTextArea(20, 50);    //display box
    ...
    public void actionPerformed(ActionEvent evt){
        ...
        //Set languages
        if(evt.getSource() == languageComboTool){
            JComboBox cb = (JComboBox)evt.getSource();
            ...
            if(contact9.equals("English")){
                ...
                sendButton.setText(r.getString("SEND"));
                sendButtonTool.setText(r.getString("SEND"));
                clearButtonTool.setText(r.getString("CLEAR"));
                
                receiverCombo.setSelectedIndex(0);
                receiverCombo.insertItemAt(r.getString("SELECT RECEIVER"), 0);
                receiverCombo.setSelectedIndex(0);
                receiverCombo.removeItemAt(1);
                
                senderCombo.setSelectedIndex(0);
                senderCombo.insertItemAt(r.getString("SELECT SENDER"), 0);
                senderCombo.setSelectedIndex(0);
                senderCombo.removeItemAt(1);
                
                receiverComboTool.setSelectedIndex(0);
                receiverComboTool.insertItemAt(r.getString("SELECT RECEIVER"), 0);
                receiverComboTool.setSelectedIndex(0);
                receiverComboTool.removeItemAt(1);
                
                senderComboTool.setSelectedIndex(0);
                senderComboTool.insertItemAt(r.getString("SELECT SENDER"), 0);
                senderComboTool.setSelectedIndex(0);
                senderComboTool.removeItemAt(1);
                
                fileMenu.setText(r.getString("FILE"));
                receiverMenu.setText(r.getString("CHANGE RECEIVER"));
                senderMenu.setText(r.getString("CHANGE SENDER"));
                sendMessageMenuItem.setText(r.getString("SEND MESSAGE"));
                clearMessageMenuItem.setText(r.getString("CLEAR TEXT BOX"));
            }
